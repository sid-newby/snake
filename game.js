class MyScene extends Phaser.Scene {
    ...
    create() {
      ...
      this.startText = this.add.text(800, 450, 'you cant read.', {
        fontSize: '64px',
        fill: '#ffffff',
        stroke: '#0bb6dd',
        strokeThickness: 6
    ...
    update() {
      ...
      this.physics.overlap(
        this.face,
        [this.pestControl, this.unicorn, this.bumblebee],
    ...
    moveEnemyTowards(enemy, speed) {
      ...
      enemy.setVelocity(Math.cos(angle) * speed * 50, Math.sin(angle) * speed * 50)
    }
    ...
    revealGameBoard() {
      this.coverScreen.setVisible(false)
